...
{
    internal class GreaterOrEqualPerformRule : BinaryInequalityPerformRuleBase
    {
        protected override BinaryOperator BinaryOperator => BinaryOperator.GreaterOrEquals;
